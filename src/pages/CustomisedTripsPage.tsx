        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-start space-x-3">
                      <CheckCircle className="h-5 w-5 text-[#e0aa04] mt-0.5 flex-shrink-0" />
            ...
            <div className="space-y-6">
              ...
              >
                <h3 className="text-lg font-bold text-[#e0aa04] mb-2">Need help planning an inclusive adventure for a group?</h3>
                <p className="text-white/70 text-sm mb-5">Write to us with your requirements and we'll get back to you.</p>
                <div className="space-y-3">
                  ...
                  <a href="tel:+919643718789"
                    className="flex items-center space-x-3 bg-white/10 hover:bg-white/20 rounded-xl px-4 py-3 transition-colors duration-300">
                    <Phone className="h-5 w-5 text-[#e0aa04] flex-shrink-0" />
                    <div>
                      <div className="text-white font-medium text-sm">+91 9643718789</div>
                      <div className="text-white/60 text-xs">Mon–Fri, 9 am to 5 pm</div>
                    </div>
                  </a>
                </div>
              </motion.div>
      ...
      <section className="py-20 bg-[#18363a]" id="enquiry">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
          >
            <SectionTitle title="Fill the Enquiry Form" align="left" className="mb-8" light={true} />
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-1">School / Organisation</label>
              ...
              <div>
                <label className="block text-sm font-medium text-white/80 mb-1">Tell us about your requirements</label>
