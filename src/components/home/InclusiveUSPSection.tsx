...
const InclusiveUSPSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-[#18363a]">
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6 md:gap-8 mt-8 sm:mt-14">
          {uspFeatures.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="text-left group bg-white/95 border border-white/20 p-3 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl shadow-md hover:shadow-[0_8px_30px_rgb(0,0,0,0.3)] transition-all duration-300 relative overflow-hidden"
              >
                ...
                <div className="inline-flex items-center justify-center w-10 h-10 sm:w-14 sm:h-14 bg-[#e8f5f6] text-[#214b51] rounded-lg sm:rounded-xl mb-3 sm:mb-6 group-hover:bg-[#e0aa04] group-hover:text-white transition-colors duration-300 shadow-sm border border-[#d1ebed] group-hover:border-transparent">
                  <IconComponent className="h-5 w-5 sm:h-7 sm:w-7" />
                </div>
                <h3 className="text-sm sm:text-xl font-bold text-[#18363a] mb-1 sm:mb-3">
                  {feature.title}
                </h3>
                <p className="text-[#377d87] leading-snug sm:leading-relaxed text-xs sm:text-sm">
                  {feature.description}
                </p>
              </motion.div>
            );
